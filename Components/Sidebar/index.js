...
import { FaBoxOpen, FaCalendarAlt, FaCashRegister, FaDollarSign, FaRegBuilding, FaRegCalendar, FaUserAlt, FaUserInjured, FaUsers, FaWallet } from 'react-icons/fa'
...
const Sidebar = (props) => {
  ...
  return (
    <div className="fixed z-30 inset-y-0 left-0 w-50 transition duration-300 transform bg-blueTheme overflow-y-auto translate-x-0 ease-out mt-12">
      ...
      <Menu.Nav>
        <Menu.Item href='/usuario' Icon={FaUserAlt}>Usuário</Menu.Item>
